...
(function ($) {
    $.fakeLoader = function(options) {
        ...
        var spinner05 = '<div class="fl fl-spinner spinner5">'
                    //   + '<a class="flex-center" style="margin-left: 10px; margin-top: 100px; font-size: 30px; color: #ffffff;">ROOMIE</a>'
                      + '<img class="flex-center" style="margin-left: -102px; margin-top: -120px; height: 100px; object-fit: contain;" src="./resources/image/Roomie6.png">'
        ...
        // window.onload = setTimeout('location.href= "https://naver.com"', 3000)
    }; 
}(jQuery));
