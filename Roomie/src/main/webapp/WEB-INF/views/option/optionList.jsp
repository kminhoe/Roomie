					...
					<input type="hidden" name="MEM_IDX" value="1">
						...
						<div class="_ab3p" style="justify-content: center;">
							<aside class="_ad6_" style="text-align: left; padding-left: 0px;">
								<label class="_ab3q"><button>비밀번호 변경</button></label>
							</aside>
						</div>
						<div class="_ab3p" style="justify-content: center;">
							<aside class="_ad6_" style="text-align: left; padding-left: 0px; flex: none;">
								<label class="_ab3q"><a href="/roomie/passwordcheck.ya">비밀번호를 잊으셨나요?</a></label>
							</aside>
						</div>
					</form>
				</div>
