  ...
  <div class="birthday-container">
	...
	<c:choose>
	  <c:when test="${status == 'email'}">
	  	<!-- 이메일 > 회원가입 > 생년월일 -->
	    <form class="form" id="emailForm" method="post" action="/roomie/emailConfirmation.ya">
	  ...
	  <c:otherwise>
	    <!-- 카카오톡 > 회원가입 > 생년월일 -->
	    <form class="form" id="kakaoForm" method="post" action="/roomie/kakaoSignupSuccess.ya">
	      <div class="flex-center">
	        <a style="font-size: 14px; font-weight: bolder; color: #262626; margin-top: 20px;">생일 추가</a>
	      </div>
	      <div class="flex-center" style="margin-top: 20px;">
  ...
  <script>
    $(function(){
      var html = '';
        ...
        submitHandler : function (kakaoForm){
        	alert("회원가입을 축하드립니다.");
        	kakaoForm.submit();   //유효성 검사를 통과시 전송
        },
        success : function(e){
            //
        }
